...
router.post("/", auth_controller_1.protect, uploader.any(), user_controller_1.createUser); // Create product
...
router.put("/:id", auth_controller_1.protect, uploader.any(), user_controller_1.updateUser); // Update product
